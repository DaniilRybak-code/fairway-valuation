...
# PROFILES is assembled at the END of this file now, because REAL_3 is defined below. It used to
# be built here, which silently excluded every fixture added after this line.
...
# =============================================================================================
# THE MARCH TO 100. 57 more real companies, taking the fixture set from 43 to 100.
#
# DANIIL, 3-Sep-2026: "March should be done to 100, without revenue numbers, just checking that we
# have sufficient depth and breadth of data lake. Take product hunt and YC companies randomly."
#
# The gate is NOT "does this company get a priced range". It is "can the engine narrow the world
# to a defensible comparable set for a company it has never seen". tools/peer_universe_check.py
# scores exactly that, and needs no revenue on any fixture.
#
# WHERE THESE CAME FROM, AND WHY IT MATTERS THAT THEY ARE REAL. Every one exists: 44 read off its
# own ycombinator.com/companies page (Summer 2026, Spring 2026, Winter 2026, Fall 2026) and 13 off
# its own Product Hunt page. The one-line description is the company's OWN published tagline, not
# a paraphrase of it. Five candidates were rejected during sourcing because the slug resolved to
# an older company, which is the failure mode to watch: short common-word slugs get reused.
#
# RANDOM MEANS RANDOM, INCLUDING THE ONES WE CANNOT PRICE. Three are outside the market this
# product is aimed at: Hop Aero (rocket cargo into contested airspace), Ultrasonium (metal
# manufacturing) and Apollo Atomics (compact nuclear reactors). They are kept rather than quietly
# dropped, because a fixture set curated down to what we already cover would score well and tell
# us nothing. OUT_OF_MARKET below names them so the score can be read both ways.
#
# NO REVENUE, NO GROWTH, NO MARGIN, exactly as on REAL and REAL_2. No website publishes them, and
# injecting synthetic ones moved 42 of 43 peer selections when it was tried on 3-Sep.
OUT_OF_MARKET = ('hop-aero', 'ultrasonium', 'apollo-atomics')
...
REAL_3 = [
 ...
 ('magma', "Monetize your agent's traces",
  dict(archetype='Data, AI & Developer Tools', archetype_secondary='',
   ...
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Agent Observability|LLM Trace Capture|Training Data Marketplace|Agent Telemetry|Model Evaluation Data')),
 ('6thsense', 'Nervous system for physical AI',
  dict(archetype='Data, AI & Developer Tools', archetype_secondary='Design & Engineering',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='ENT_SALES',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Robotics Perception|Sensor Fusion|Physical AI Runtime|Embodied AI Infrastructure|Robot Control Stack')),
 ('osseus', 'The intelligent development platform for robotics',
  dict(archetype='Design & Engineering', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='SEATS', product_role='PLATFORM_SUITE', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Robotics Development Platform|Simulation And Test|Robot Fleet Tooling|Embedded Deployment|Robotics CI')),
 ('projectx', 'Agent native workspace for heavy parallel workflows on the web',
  dict(archetype='Cloud & Infrastructure', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Agent Workspace|Parallel Browser Compute|Headless Runtime|Agent Sandboxing|Cloud Execution Environment')),
 ('maritime', 'The managed cloud for AI agents',
  dict(archetype='Cloud & Infrastructure', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Managed Agent Hosting|Agent Runtime|Serverless Agents|Agent Infrastructure|Compute For AI Agents')),
 ('sim', 'Open-source workspace for AI agents and workflows',
  dict(archetype='Data, AI & Developer Tools', archetype_secondary='Business Applications',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='PLATFORM_SUITE', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Agent Workflow Builder|Open Source AI Workspace|Workflow Orchestration|Agent Chaining|Self Hosted Agents')),
 ('rybbit', 'The open source Google Analytics replacement',
  dict(archetype='Data, AI & Developer Tools', archetype_secondary='Marketing & Customer Engagement',
   industry='Horizontal', function='Data & Analytics', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
   product_tags='Product Analytics|Open Source Analytics|Privacy First Tracking|Web Analytics|Session Replay')),
 ('atlas-new', 'The AI agent for maps and spatial data',
  dict(archetype='Data, AI & Developer Tools', archetype_secondary='',
   industry='Horizontal', function='Data & Analytics', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Geospatial Analysis|Maps API|Spatial Data Agent|GIS Automation|Location Intelligence')),
]
...
REAL_3 += [
 ('emergent', 'Advanced AI app builder that ships full-stack apps',
  dict(archetype='Design & Engineering', archetype_secondary='Data, AI & Developer Tools',
   ...
   revenue_model='CONSUMPTION', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='AI App Builder|Full Stack Code Generation|Prompt To App|Deployment Automation|Vibe Coding')),
 ('orchids', 'The best way to build any app',
  dict(archetype='Design & Engineering', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='PROSUMER', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='AI App Builder|No Code App Generation|Prompt To App|Web App Scaffolding|Vibe Coding')),
 ('21st', 'UI building blocks for the agentic internet',
  dict(archetype='Design & Engineering', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_EMBEDDED', growth=None, gm=None,
   product_tags='UI Component Library|Design System Components|React Components|Frontend Building Blocks|Component Registry')),
 ('chronicle', 'AI presentations without the AI slop',
  dict(archetype='Design & Engineering', archetype_secondary='Business Applications',
   industry='Horizontal', function='Productivity', buyer='PROSUMER', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='AI Presentation Builder|Slide Generation|Deck Design|Document Storytelling|Branded Templates')),
 ('caution', "Hosting platform for software you don't want to have hacked",
  dict(archetype='Cybersecurity', archetype_secondary='Cloud & Infrastructure',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
   product_tags='Secure Hosting|Hardened Runtime|Application Isolation|Managed Security|Zero Trust Deployment')),
 ('bylaw', 'Guarantee your agents use the right evidence before they act',
  dict(archetype='Cybersecurity', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='MIDMARKET',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Agent Guardrails|AI Governance|Evidence Grounding|Policy Enforcement For Agents|AI Audit Trail')),
 ('nebula-security', 'Autonomous AI defense system for cyber attack',
  dict(archetype='Cybersecurity', archetype_secondary='',
   industry='Horizontal', function='Operations', buyer='LOB', gtm_motion='ENT_SALES',
   revenue_model='SEATS', product_role='PLATFORM_SUITE', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Autonomous Threat Response|AI SOC|Incident Detection|Attack Simulation|Security Automation')),
 ('care-gp', 'AI agents to run primary healthcare operations',
  dict(archetype='Vertical Software', archetype_secondary='',
   industry='Healthcare & Life Sciences', function='Operations', buyer='SMB', gtm_motion='MIDMARKET',
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Primary Care Operations|Clinic Practice Management|Patient Intake Automation|Medical Front Office|Healthcare Agents')),
 ('plena-health', 'The AI operating system for specialty medical practices',
  dict(archetype='Vertical Software', archetype_secondary='',
   industry='Healthcare & Life Sciences', function='Operations', buyer='SMB', gtm_motion='MIDMARKET',
   revenue_model='SEATS', product_role='PLATFORM_SUITE', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Specialty Practice Management|Clinical Workflow|Revenue Cycle Management|Patient Scheduling|Medical Records Automation')),
 ('scheduling-wizard', 'Logistics infrastructure to modernize healthcare operations',
  dict(archetype='Vertical Software', archetype_secondary='Commerce Enablement & Fulfilment',
   industry='Healthcare & Life Sciences', function='Operations', buyer='LOB', gtm_motion='ENT_SALES',
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_EMBEDDED', growth=None, gm=None,
   product_tags='Healthcare Logistics|Specimen And Supply Routing|Hospital Operations|Clinical Scheduling|Care Coordination')),
]
...
REAL_3 += [
 ('marble', 'The autonomous back-of-house for restaurants',
  dict(archetype='Vertical Software', archetype_secondary='',
   ...
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Restaurant Back Office|Inventory And Ordering|Food Cost Management|Vendor Invoice Automation|Restaurant Operations')),
 ('osmaura', 'AI growth engine for corporate law firms',
  dict(archetype='Vertical Software', archetype_secondary='Marketing & Customer Engagement',
   industry='Legal & Professional Services', function='Marketing', buyer='SMB', gtm_motion='MIDMARKET',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Legal Business Development|Law Firm Marketing|Client Origination|Pitch Automation|Professional Services Growth')),
 ('payna', 'AI licensing agent for regulated industries',
  dict(archetype='Vertical Software', archetype_secondary='',
   industry='Legal & Professional Services', function='Operations', buyer='LOB', gtm_motion='MIDMARKET',
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Licensing Compliance|Regulatory Filing Automation|Permit Management|Multi State Licensing|Compliance Workflow')),
 ('edviro', 'AI that operates energy infrastructure',
  dict(archetype='Vertical Software', archetype_secondary='',
   ...
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Energy Asset Operations|Grid Operations Software|Utility Automation|Renewable Asset Management|Industrial Control Software')),
 ('levocred', 'AI workforce for lenders',
  dict(archetype='Vertical Software', archetype_secondary='Lending & Credit',
   ...
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Loan Origination Automation|Lending Back Office|Credit Operations|Document Verification|Servicing Automation')),
 ('open-wearables', 'Open infrastructure for wearable-powered health products',
  dict(archetype='Vertical Software', archetype_secondary='Cloud & Infrastructure',
   industry='Healthcare & Life Sciences', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
 ...
 ('agentcard', 'Debit cards for AI agents',
  dict(archetype='Card Issuing & BaaS', archetype_secondary='Commerce & Payments Software',
   ...
   revenue_model='TRANSACTION_FEE', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Agent Payments|Virtual Card Issuing|Programmatic Spend Controls|Machine To Machine Payments|Card API')),
 ('paymentkit', 'Billing that survives a processor shutdown',
  dict(archetype='Commerce & Payments Software', archetype_secondary='Merchant Acquiring & PSP',
   industry='Financial Services', function='Finance & Payments', buyer='DEV', gtm_motion='PLG',
   revenue_model='TRANSACTION_FEE', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
   product_tags='Billing Infrastructure|Payment Orchestration|Processor Redundancy|Subscription Billing|Payments Failover')),
 ('unifold', 'Multi-chain deposit and payment infrastructure',
  dict(archetype='Crypto & Digital Assets', archetype_secondary='Commerce & Payments Software',
   industry='Financial Services', function='Finance & Payments', buyer='DEV', gtm_motion='PLG',
   revenue_model='TRANSACTION_FEE', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
   product_tags='Stablecoin Payments|Multi Chain Deposits|Crypto Payment Rails|On Ramp Off Ramp|Digital Asset Custody')),
]
...
REAL_3 += [
 ...
 ('denta', 'AI-native dental insurance',
  dict(archetype='Insurance Technology', archetype_secondary='Vertical Software',
   industry='Healthcare & Life Sciences', function='Operations', buyer='SMB', gtm_motion='PAID_ACQUISITION',
   revenue_model='TRANSACTION_FEE', product_role='SOR', asset_intensity='', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Dental Insurance|Benefits Administration|Claims Adjudication|Provider Network|Digital Insurance')),
 ('insurf', 'The AI-native decision layer for health insurance',
  dict(archetype='Insurance Technology', archetype_secondary='Vertical Software',
   industry='Healthcare & Life Sciences', function='Operations', buyer='LOB', gtm_motion='ENT_SALES',
   revenue_model='SEATS', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Payer Decisioning|Prior Authorisation|Claims Review|Health Plan Automation|Utilisation Management')),
 ('evergrove', "Voice agents that accelerate care coordination in workers' comp",
  dict(archetype='Insurance Technology', archetype_secondary='Vertical Software',
   industry='Healthcare & Life Sciences', function='Operations', buyer='LOB', gtm_motion='ENT_SALES',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Workers Compensation|Voice Agents|Care Coordination|Claims Communication|Case Management')),
 ('lato', 'AI-powered market research and deal diligence for institutional investors',
  dict(archetype='Financial Data & Index', archetype_secondary='Data, AI & Developer Tools',
   industry='Financial Services', function='Data & Analytics', buyer='LOB', gtm_motion='ENT_SALES',
   revenue_model='SEATS', product_role='AGGREGATOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Investment Research|Deal Diligence|Market Intelligence|Private Markets Data|Research Automation')),
 ('tash', 'The investment platform for sports and trading cards',
 ...
 ('bizmark', 'Agentic supply chain optimization',
  dict(archetype='Commerce Enablement & Fulfilment', archetype_secondary='Business Applications',
   ...
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Supply Chain Optimisation|Procurement Automation|Demand Planning|Supplier Management|Inventory Agents')),
 ('blindspot', 'Book 2.5m billboards worldwide like you book an Uber',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='Third-Party Marketplace',
   industry='Horizontal', function='Marketing', buyer='SMB', gtm_motion='PLG',
   revenue_model='TAKE_RATE', product_role='AGGREGATOR', asset_intensity='NONE', purchase_frequency='EPISODIC',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
   product_tags='Out Of Home Advertising|Billboard Booking|Programmatic OOH|Ad Inventory Marketplace|Campaign Planning')),
]
...
REAL_3 += [
 ('clarify', 'The autonomous CRM that helps you sell more',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='Business Applications',
   industry='Horizontal', function='Sales', buyer='SMB', gtm_motion='PLG',
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='AI CRM|Pipeline Management|Sales Automation|Contact Enrichment|Deal Intelligence')),
 ('lightfield', 'AI-native CRM that builds itself and does work for you',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='Business Applications',
   industry='Horizontal', function='Sales', buyer='SMB', gtm_motion='PLG',
   revenue_model='SEATS', product_role='SOR', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='AI CRM|Self Building CRM|Sales Workflow Automation|Relationship Intelligence|Pipeline Hygiene')),
 ('guideflow', 'The AI demo automation platform for SaaS',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='',
   industry='Horizontal', function='Marketing', buyer='SMB', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_EMBEDDED', growth=None, gm=None,
   product_tags='Interactive Product Demos|Demo Automation|Sales Enablement|Product Tours|Buyer Engagement')),
 ('floqer', 'The AI copilot for GTM data automation',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Sales', buyer='SMB', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='GTM Data Enrichment|Lead Research Automation|Outbound Workflows|Prospect Scoring|Sales Data Pipelines')),
 ('postiz', 'Agentic social media scheduler',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Marketing', buyer='SMB', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_EMBEDDED', growth=None, gm=None,
   product_tags='Social Media Scheduling|Multi Platform Publishing|Content Calendar|Open Source Social Tools|Agent Publishing')),
 ('akkari', 'Autonomous customer operations',
  dict(archetype='Marketing & Customer Engagement', archetype_secondary='Communications & Collaboration',
   industry='Horizontal', function='Operations', buyer='LOB', gtm_motion='MIDMARKET',
   revenue_model='CONSUMPTION', product_role='PLATFORM_SUITE', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='AI Customer Support|Ticket Deflection|Customer Operations Automation|Support Agents|Service Workflows')),
 ('dograh', 'The open source VAPI alternative',
  dict(archetype='Communications & Collaboration', archetype_secondary='Data, AI & Developer Tools',
   industry='Horizontal', function='Engineering & Design', buyer='DEV', gtm_motion='PLG',
   revenue_model='CONSUMPTION', product_role='INFRA_LAYER', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Voice AI Infrastructure|Telephony API|Open Source Voice Agents|Speech Pipeline|Call Automation')),
 ('fathom', 'AI meeting notes, bot-free and inside your chat tools',
  dict(archetype='Communications & Collaboration', archetype_secondary='Business Applications',
   industry='Horizontal', function='Productivity', buyer='SMB', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Meeting Notes|Call Recording|Transcription And Summary|CRM Sync|Conversation Intelligence')),
 ('wispr-flow', 'Voice productivity for your writing and your meetings',
  dict(archetype='Consumer & Prosumer Software', archetype_secondary='Communications & Collaboration',
   industry='Horizontal', function='Productivity', buyer='PROSUMER', gtm_motion='PLG',
   revenue_model='SUBSCRIPTION_CONSUMER', product_role='TOOL', asset_intensity='', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Voice Dictation|Speech To Text|Writing Assistant|Desktop Productivity|Hands Free Input')),
 ('welltory', 'The one app for your health',
  dict(archetype='Consumer & Prosumer Software', archetype_secondary='',
   industry='Healthcare & Life Sciences', function='Productivity', buyer='CONSUMER', gtm_motion='PAID_ACQUISITION',
   revenue_model='SUBSCRIPTION_CONSUMER', product_role='DESTINATION', asset_intensity='', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_EMBEDDED', growth=None, gm=None,
   product_tags='Health Tracking App|Heart Rate Variability|Wearable Data Sync|Personal Health Insights|Wellness Subscription')),
]

REAL_3 += [
 ('planeat', 'AI turns your health goals into a seven-day menu and grocery list',
  dict(archetype='Consumer & Prosumer Software', archetype_secondary='',
   industry='Food & Grocery', function='Productivity', buyer='CONSUMER', gtm_motion='PAID_ACQUISITION',
   revenue_model='SUBSCRIPTION_CONSUMER', product_role='TOOL', asset_intensity='NONE', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Meal Planning App|Grocery List Generation|Nutrition Tracking|Recipe Personalisation|Diet Coaching')),
 ('bloomy', 'AI-native learning for every school',
  dict(archetype='Online Learning', archetype_secondary='Vertical Software',
   industry='Education', function='Operations', buyer='LOB', gtm_motion='ENT_SALES',
   revenue_model='SEATS', product_role='PLATFORM_SUITE', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='K12 Learning Platform|Adaptive Learning|Curriculum Delivery|Teacher Tools|School Software')),
 ('wondering', 'Duolingo for learning anything',
  dict(archetype='Online Learning', archetype_secondary='Consumer & Prosumer Software',
   industry='Education', function='Productivity', buyer='CONSUMER', gtm_motion='PLG',
   revenue_model='SUBSCRIPTION_CONSUMER', product_role='DESTINATION', asset_intensity='', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Consumer Learning App|Gamified Lessons|Microlearning|Streaks And Retention|Self Paced Courses')),
 ('befreed', 'Learn anything with your own personal audio agent',
  dict(archetype='Online Learning', archetype_secondary='Consumer & Prosumer Software',
   industry='Education', function='Content & Community', buyer='CONSUMER', gtm_motion='PAID_ACQUISITION',
   revenue_model='SUBSCRIPTION_CONSUMER', product_role='DESTINATION', asset_intensity='', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Audio Learning|Personalised Podcasts|Book Summaries|Voice Tutor|Consumer Education Subscription')),
 ('tsenta', 'AI career agent that finds matching jobs and applies on your behalf',
  dict(archetype='Freelance & Services Marketplace', archetype_secondary='Consumer & Prosumer Software',
   industry='Horizontal', function='HR & Workforce', buyer='CONSUMER', gtm_motion='PLG',
   revenue_model='SUBSCRIPTION_CONSUMER', product_role='AGGREGATOR', asset_intensity='', purchase_frequency='SUBSCRIPTION',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Job Search Automation|Application Agent|Candidate Matching|Career Coaching|Job Aggregation')),
 ('standout', 'Agentic hiring marketplace',
  dict(archetype='Freelance & Services Marketplace', archetype_secondary='Business Applications',
   industry='Horizontal', function='HR & Workforce', buyer='SMB', gtm_motion='MIDMARKET',
   revenue_model='TAKE_RATE', product_role='AGGREGATOR', asset_intensity='', purchase_frequency='EPISODIC',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Hiring Marketplace|Candidate Sourcing|Screening Automation|Recruiter Agents|Talent Matching')),
 ('clera', 'An AI agent matching candidates to the right roles',
  dict(archetype='Freelance & Services Marketplace', archetype_secondary='Business Applications',
   industry='Horizontal', function='HR & Workforce', buyer='SMB', gtm_motion='PLG',
   revenue_model='SEATS', product_role='TOOL', asset_intensity='', purchase_frequency='',
   ai_stance='AI_NATIVE', growth=None, gm=None,
   product_tags='Candidate Matching|Applicant Screening|Recruiting Automation|Talent Pipeline|Interview Scheduling')),
 ('hop-aero', 'Autonomous rocket cargo delivery to contested environments in minutes',
  dict(archetype='Local Delivery & On-Demand', archetype_secondary='Commerce Enablement & Fulfilment',
   industry='Horizontal', function='Operations', buyer='LOB', gtm_motion='ENT_SALES',
 ...
 ('apollo-atomics', 'We make the most compact nuclear reactors',
  dict(archetype='Owned-Inventory Retail', archetype_secondary='Design & Engineering',
   ...
   revenue_model='PRODUCT_SALES', product_role='BRAND', asset_intensity='OWN_PRODUCT', purchase_frequency='EPISODIC',
   ai_stance='AI_NEUTRAL', growth=None, gm=None,
   product_tags='Microreactor|Nuclear Power|Distributed Generation|Energy Hardware|Baseload Power')),
]
